        ...
        <div className='pageContainer redBackground'>
            <div className='longSection'>
                ...
                <div style={{
                    ...
                    <iframe width="380" height="315" src="https://www.youtube.com/embed/1K--JPaEq8A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
